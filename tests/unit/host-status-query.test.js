...
function readSource(relativePath) {
  ...
  return fs.readFileSync(path.join(EXTENSION_ROOT, relativePath), "utf-8");
...
function loadRuntimeSandbox() {
  ...
  const contractSrc = fs.readFileSync(
    ...
    path.join(EXTENSION_ROOT, "agentao-contract.js"),
  ...
  const runtimeSrc = fs.readFileSync(
    ...
    path.join(EXTENSION_ROOT, "service-worker-runtime.js"),
