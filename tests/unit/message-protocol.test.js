...
const { loadContract, PROJECT_ROOT, EXTENSION_ROOT } = require("../helpers/load-contract");
...
function readSource(relativePath) {
  ...
  // Files under native-host/ live at the project root, not in extension/.
  // All other source files (sidepanel.js, options.js, service-worker-runtime.js,
  // agentao-contract.js) were moved into extension/.
  const root = relativePath.startsWith("native-host/")
    ? PROJECT_ROOT
    : EXTENSION_ROOT;
