...
from installer import HOST_NAME, DEFAULT_EXTENSION_ID, install_host  # noqa: E402
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        help=(
            "The Chrome extension ID (32-char string from chrome://extensions/). "
            "Defaults to the fixed ID derived from the manifest.json key field: "
